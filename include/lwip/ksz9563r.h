...
#define  KSZ9563R_STATUS_READ_ERROR            ((int32_t)-5)
#define  KSZ9563R_STATUS_WRITE_ERROR           ((int32_t)-4)
#define  KSZ9563R_STATUS_ADDRESS_ERROR         ((int32_t)-3)
#define  KSZ9563R_STATUS_RESET_TIMEOUT         ((int32_t)-2)
#define  KSZ9563R_STATUS_ERROR                 ((int32_t)-1)
#define  KSZ9563R_STATUS_OK                    ((int32_t) 0)
#define  KSZ9563R_STATUS_LINK_DOWN             ((int32_t) 1)
#define  KSZ9563R_STATUS_100MBITS_FULLDUPLEX   ((int32_t) 2)
#define  KSZ9563R_STATUS_100MBITS_HALFDUPLEX   ((int32_t) 3)
#define  KSZ9563R_STATUS_10MBITS_FULLDUPLEX    ((int32_t) 4)
#define  KSZ9563R_STATUS_10MBITS_HALFDUPLEX    ((int32_t) 5)
#define  KSZ9563R_STATUS_AUTONEGO_NOTDONE      ((int32_t) 6)
#define  KSZ9563R_STATUS_1000MBITS_FULLDUPLEX  ((int32_t) 7)

typedef int32_t  (*ksz9563r_Init_Func) (void); 
typedef int32_t  (*ksz9563r_DeInit_Func) (void);
typedef int32_t  (*ksz9563r_ReadReg_Func)   (uint32_t, uint32_t, uint32_t *);
typedef int32_t  (*ksz9563r_WriteReg_Func)  (uint32_t, uint32_t, uint32_t);
typedef int32_t  (*ksz9563r_ReadReg16_Func)   (uint32_t, uint32_t, uint32_t *);
typedef int32_t  (*ksz9563r_WriteReg16_Func)  (uint32_t, uint32_t, uint32_t);
typedef int32_t  (*ksz9563r_GetTick_Func)  (void);

typedef struct 
{                   
  ksz9563r_Init_Func      Init; 
  ksz9563r_DeInit_Func    DeInit;
  ksz9563r_WriteReg_Func  WriteReg;
  ksz9563r_ReadReg_Func   ReadReg; 
  ksz9563r_WriteReg16_Func  WriteReg16;
  ksz9563r_ReadReg16_Func   ReadReg16; 
  ksz9563r_GetTick_Func   GetTick;   
} ksz9563r_IOCtx_t;  
...
// int32_t KSZ9563R_DisablePowerDownMode(ksz9563r_t *pObj);
// int32_t KSZ9563R_EnablePowerDownMode(ksz9563r_t *pObj);
// int32_t KSZ9563R_StartAutoNego(ksz9563r_t *pObj);
int32_t KSZ9563R_GetLinkState(ksz9563r_t *pObj);
// int32_t KSZ9563R_SetLinkState(ksz9563r_t *pObj, uint32_t LinkState);
// int32_t KSZ9563R_EnableLoopbackMode(ksz9563r_t *pObj);
// int32_t KSZ9563R_DisableLoopbackMode(ksz9563r_t *pObj);
// int32_t KSZ9563R_EnableIT(ksz9563r_t *pObj, uint32_t Interrupt);
// int32_t KSZ9563R_DisableIT(ksz9563r_t *pObj, uint32_t Interrupt);
// int32_t KSZ9563R_ClearIT(ksz9563r_t *pObj, uint32_t Interrupt);
// int32_t KSZ9563R_GetITStatus(ksz9563r_t *pObj, uint32_t Interrupt);
